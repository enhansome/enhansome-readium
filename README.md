...
* [Readium Mobile](https://readium.org/mobile)
  ...
  * [Kotlin toolkit](https://github.com/readium/kotlin-toolkit) ⭐ 370 | 🐛 63 | 🌐 Kotlin | 📅 2026-08-03 for Android and Chrome OS
...
* [Thorium Desktop](https://github.com/edrlab/thorium-reader) ⭐ 2,830 | 🐛 173 | 🌐 TypeScript | 📅 2026-08-20 - A desktop app for EPUB, PDF and audiobooks on Windows, macOS and Linux
...
* [Epub.js](https://github.com/futurepress/epub.js/) ⭐ 6,945 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 - An ebook viewer written in JS
* [Vivliostyle](https://github.com/vivliostyle/vivliostyle.js) ⭐ 780 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-20 - A document and publication viewer written in JS
...
* [Flutter Readium](https://github.com/Notalib/flutter_readium) ⭐ 31 | 🐛 20 | 🌐 Dart | 📅 2026-08-20 - A Flutter wrapper for Readium Mobile and Web
