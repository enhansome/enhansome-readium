...
* [Readium Mobile](https://readium.org/mobile)
  * [Swift toolkit](https://github.com/readium/swift-toolkit) ⭐ 552 | 🐛 58 | 🌐 Swift | 📅 2026-09-16 for iOS, iPadOS and macOS
...
* [Readium Web](https://readium.org/web)
  * [TS toolkit](https://github.com/readium/ts-toolkit) ⭐ 151 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-15 primarily used for client-side applications
  * [Go toolkit](https://github.com/readium/go-toolkit) ⭐ 68 | 🐛 11 | 🌐 Go | 📅 2026-09-14 primarily used for server-side applications

## Open-source applications

* [Thorium Desktop](https://github.com/edrlab/thorium-reader) ⭐ 2,872 | 🐛 206 | 🌐 TypeScript | 📅 2026-09-17 - A desktop app for EPUB, PDF and audiobooks on Windows, macOS and Linux
...
* [Vivliostyle](https://github.com/vivliostyle/vivliostyle.js) ⭐ 790 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-17 - A document and publication viewer written in JS
...
* [React Native Readium](https://github.com/5-stones/react-native-readium) ⭐ 173 | 🐛 13 | 🌐 HTML | 📅 2026-09-17 - A React Native wrapper for Readium Mobile & Web
* [Iridium](https://github.com/Mantano/iridium) ⭐ 108 | 🐛 62 | 🌐 Dart | 📅 2026-07-25 - A Flutter port of Readium Mobile
* [Flutter Readium](https://github.com/Notalib/flutter_readium) ⭐ 33 | 🐛 14 | 🌐 Dart | 📅 2026-09-16 - A Flutter wrapper for Readium Mobile and Web
