...
* [Thorium Desktop](https://github.com/edrlab/thorium-reader) ⭐ 2,871 | 🐛 202 | 🌐 TypeScript | 📅 2026-09-16 - A desktop app for EPUB, PDF and audiobooks on Windows, macOS and Linux
...
* [Vivliostyle](https://github.com/vivliostyle/vivliostyle.js) ⭐ 790 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-16 - A document and publication viewer written in JS
...
* [React Native Readium](https://github.com/5-stones/react-native-readium) ⭐ 173 | 🐛 13 | 🌐 HTML | 📅 2026-09-16 - A React Native wrapper for Readium Mobile & Web
* [Iridium](https://github.com/Mantano/iridium) ⭐ 108 | 🐛 62 | 🌐 Dart | 📅 2026-07-25 - A Flutter port of Readium Mobile
* [Flutter Readium](https://github.com/Notalib/flutter_readium) ⭐ 33 | 🐛 8 | 🌐 Dart | 📅 2026-09-16 - A Flutter wrapper for Readium Mobile and Web
